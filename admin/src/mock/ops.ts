...
const phones: CloudPhoneRec[] = [
  { id: 1, user_id: 1001, cp_id: 'cp-bj-0001', name: '运营机-01', status: 'RUNNING', vm_id: 'vm-bj-0001', image_id: 'img-android13-001', proxy_id: 1, remark: '日常运营', created_at: '2026-05-01T08:19:57', updated_at: '2026-06-02T08:19:57' },
  { id: 2, user_id: 1001, cp_id: 'cp-bj-0002', name: '运营机-02', status: 'STOPPED', vm_id: 'vm-bj-0001', image_id: 'img-android13-001', proxy_id: 0, remark: '', created_at: '2026-05-02T10:31:02', updated_at: '2026-06-01T22:10:02' },
  { id: 3, user_id: 1002, cp_id: 'cp-sh-0001', name: '测试机-01', status: 'STARTING', vm_id: 'vm-sh-0001', image_id: 'img-android12-002', proxy_id: 3, remark: '启动中', created_at: '2026-05-05T15:42:33', updated_at: '2026-06-02T09:00:01' },
  { id: 4, user_id: 1003, cp_id: '', name: '待分配实例', status: 'CREATED', vm_id: 'vm-gz-0001', image_id: 'img-android14-004', proxy_id: 0, remark: '刚创建未就绪', created_at: '2026-06-01T18:00:21', updated_at: '2026-06-01T18:00:21' },
  { id: 5, user_id: 1002, cp_id: 'cp-sh-0002', name: '测试机-02', status: 'RUNNING', vm_id: 'vm-sh-0002', image_id: 'img-android12-002', proxy_id: 5, remark: '', created_at: '2026-05-06T09:11:08', updated_at: '2026-06-02T07:11:08' },
]
let phoneSeq = 100
