...
let seq = 10
const scripts: Rec[] = [
  { id: 1, store: true, scriptId: 200, name: 'Hello World', description: '连通性测试脚本', version: '1.0.0', luaContent: 'log("hello world from glory")', fileName: 'hello.lua', status: 'enabled', uploaderId: 0, createTime: '2026-06-01 09:00:00', updateTime: '2026-06-01 09:00:00' },
