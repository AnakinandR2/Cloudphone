...
<template>
  <div class="bg-muted/30 flex flex-col gap-2 rounded-lg border px-4 py-3.5 text-sm">
    <template v-if="quote">
    ...
    <div v-else-if="loading" class="text-muted-foreground py-2 text-center text-xs">
      {{ t('billing.purchase2.quoting') }}
    </div>
