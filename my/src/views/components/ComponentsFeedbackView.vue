...
<template>
  <div class="space-y-6">
    ...
    <div class="grid gap-6 xl:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{{ t('comp.dialogs') }}</CardTitle>
          <CardDescription>{{ t('comp.dialogsDesc') }}</CardDescription>
        </CardHeader>
        <CardContent class="flex flex-wrap gap-2">
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>{{ t('comp.dialogTitle') }}</DialogTitle>
                <DialogDescription>{{ t('comp.dialogDesc') }}</DialogDescription>
              </DialogHeader>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>{{ t('comp.alertTitle') }}</AlertDialogTitle>
                <AlertDialogDescription>{{ t('comp.alertDesc') }}</AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
